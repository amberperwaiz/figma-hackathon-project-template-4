...
<div className="relative md:absolute top-[-30px] left[-30px] md:left-[-100px]">
  <Image src="/images/bulb.png" alt="Bulb" width={387} height={387} className="object-contain" />
</div>


        {/* Text Content - Aligning next to the bulb */}
        <div className="left-24 relative mt-6 md:mt-0 md:ml-6 text-center md:text-left">
          {/* Pink Text */}
